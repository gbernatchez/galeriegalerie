...
function gwolle_gb_frontend_write( $shortcode_atts, $shortcode ) {
	...
	if ( isset($form_setting['form_name_enabled']) && $form_setting['form_name_enabled']  === 'true' ) {
		$label = apply_filters( 'gwolle_gb_author_name_label', __('Nom', 'gwolle-gb') );
	...
	if ( isset($form_setting['form_city_enabled']) && $form_setting['form_city_enabled']  === 'true' ) {
		$label = apply_filters( 'gwolle_gb_author_origin_label', __('Ville', 'gwolle-gb') );
	...
	if ( isset($form_setting['form_email_enabled']) && $form_setting['form_email_enabled']  === 'true' ) {
		$label = apply_filters( 'gwolle_gb_author_email_label', __('Courriel', 'gwolle-gb') );
	...
	if ( isset($form_setting['form_message_enabled']) && $form_setting['form_message_enabled']  === 'true' ) {
		$label = apply_filters( 'gwolle_gb_content_label', __('Message', 'gwolle-gb') );
	...
	$output .= '
			...
			<div class="gwolle_gb_submit">
				...
				<div class="input">
					<input type="submit" name="gwolle_gb_submit" id="gwolle_gb_submit" class="btn btn-primary" value="' . esc_attr__('Envoyer', 'gwolle-gb') . '" />
