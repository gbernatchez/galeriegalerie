...
if (function_exists('pll_register_string')) {
    pll_register_string( "Intro", "Bienvenue à l'espace de diffusion en ligne", "Galerie Galerie" );
    pll_register_string( "Formulaire", "Courriel", "Galerie Galerie" );
    pll_register_string( "Formulaire", "M'abonner", "Galerie Galerie" );
    pll_register_string( "Formulaire", "Comment nous soutenir ?", "Galerie Galerie" );
}
