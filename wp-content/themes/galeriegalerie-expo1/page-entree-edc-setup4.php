<?php 
/*
* Template name: Entrée EDC Setup 4
*/
get_header(); ?>
...
<div class="tous edcSetup">
	...
	<div class="objet balles">
		<img src="<?php echo get_template_directory_uri(); ?>/edc/medias/entree/menage-setup4-entree-bullets.png" alt="">
	</div>

	<div class="objet cartes">
		<img src="<?php echo get_template_directory_uri(); ?>/edc/medias/entree/menage-setup4-entree-cartes.png" alt="">
	</div>

	<div class="objet feuCash">
		<img src="<?php echo get_template_directory_uri(); ?>/edc/medias/404/setup1-pagenotfound-feu-poubelle.gif" alt="">
	</div>

	<div class="objet cashFeu">
		<img src="<?php echo get_template_directory_uri(); ?>/edc/medias/entree/menage-setup4-entree-cashfeu.png" alt="">
	</div>
