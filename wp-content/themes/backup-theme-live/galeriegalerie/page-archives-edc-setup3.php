<?php 
/*
* Template name: Archives EDC Setup 4
*/
get_header(); ?>
...
<div class="tous">
	...
	<div class="objet tiVomi">
		<img alt="" src="<?php echo get_template_directory_uri(); ?>/edc/medias/archives/menage-setup4-archives-vomi.png">
	</div>

	<div class="objet beerBroke">
		<img alt="" src="<?php echo get_template_directory_uri(); ?>/edc/medias/archives/menage-setup4-archives-brokenbeer.png">
	</div>
...
<div id="sol" class="coin-droit coin-gauche">
	...
	<div class="tous">
		...
		<div class="objet bureau-archive">
			<a href="<?php echo site_url(); ?>/finder" title="Consulter les archives" class="click"></a>
