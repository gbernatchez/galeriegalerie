<?php 
/*
* Template name: Salle d'archives Noël
*/
get_header(); ?>
...
<div class="tous">
	...
	<div class="objet neige8">
		<img src="<?php echo get_template_directory_uri(); ?>/images/neige2.png" alt="">
	</div>
	<div class="objet neige9">
		<img src="<?php echo get_template_directory_uri(); ?>/images/snow.png" alt="">
	</div>

	<div class="objet neige10">
		<img src="<?php echo get_template_directory_uri(); ?>/images/snow.png" alt="">
	</div>

	<div class="objet sapin">
		<img src="<?php echo get_template_directory_uri(); ?>/images/sapin.png" alt="">
	</div>
