...
<div class="tous">
	...
	<div class="objet lisa-archive">
		<img src="<?php echo get_template_directory_uri(); ?>/images/giphy7.gif">
	</div>

	<div class="objet potion-archive">
		<img src="<?php echo get_template_directory_uri(); ?>/images/potion.gif">
	</div>

	<div class="objet titefille">
		<img src="<?php echo get_template_directory_uri(); ?>/images/titefille.gif">
	</div>
