...
<?php if(!is_page('simon_provencher') && !is_page('ines_allard') && !is_page('adriana_smith') && !is_page('megane_voghell') && !is_page('livre-dor') && !is_page('accueil') && !is_home() && !(is_page_template('page-alban.php')) && !(is_page_template('page.php')) && !(is_page_template('page-alban.php'))) : ?>
...
<?php if(!is_page(5)) : ?>
  ...
  <div id="zone-menu">
    ...
    <?php if(is_page_template('page-guestbook.php') || is_page_template('page-mathieu.php') || is_page_template('page-adriana.php') || is_page_template('page-alban.php') || is_page_template('page-megane.php') || is_page_template('page-ines.php')) : ?>
      <a class="objet retour click" title="<?php echo get_the_title(7); ?>" href="<?php echo get_permalink(7); ?>">
        <img src="<?php echo get_template_directory_uri(); ?>/images/retourflehce.png">
      </a>
    <?php endif; ?>
